...
@interface FootBallListViewController ()<CommonAPIDelegate>
...
@implementation FootBallListViewController
...
- (void)viewWillAppear:(BOOL)animated
{
    ...
    dispatch_async(myqueue, ^{
        [self.commonProcessingUnit performGenericProcessingWithURL:[NSURL URLWithString:@"https://ajax.googleapis.com/ajax/services/search/images?v=1.0&q=football&rsz=8&userip=203.187.253.58"]];
    });
}
