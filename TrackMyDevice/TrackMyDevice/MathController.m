...
+ (NSString *)stringifySpeedFromDist:(float)meters overTime:(int)seconds
{
    ...
    float speedInMeters = meters / seconds;
    
    return [NSString stringWithFormat:@"%0.2f",speedInMeters];
}
...
+ (NSArray *)colorSegmentsForLocations:(NSArray *)locations
{
    ...
    for (int i = 1; i < locations.count; i++)
    {
        ...
        CLLocation *firstLocCL = [[CLLocation alloc] initWithLatitude:firstLoc.latitude.doubleValue longitude:firstLoc.longitiude.doubleValue];
        CLLocation *secondLocCL = [[CLLocation alloc] initWithLatitude:secondLoc.latitude.doubleValue longitude:secondLoc.longitiude.doubleValue];
    ...
    for (int i = 1; i < locations.count; i++) {
        ...
        coords[0].longitude = firstLoc.longitiude.doubleValue;
        
        coords[1].latitude = secondLoc.latitude.doubleValue;
        coords[1].longitude = secondLoc.longitiude.doubleValue;
